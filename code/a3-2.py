...
plotFolderPath = 'Q3' +  os.path.sep  + 'Part2' + os.path.sep + 'Plot' + os.path.sep
numpyFolderPath = 'Q3' +  os.path.sep  + 'Part2' +   os.path.sep +  'Numpy' + os.path.sep
modelFolderPath = 'Q3' +  os.path.sep  + 'Part2' +   os.path.sep +  'Model' + os.path.sep
...
def buildNetwork():
	...
	if useBias:
		qHiddenBias = tf.Variable(tf.zeros([100]))
